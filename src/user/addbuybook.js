...
import {BuyBookForm} from '../component/form';
...
class UserAddBuyBookComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            current: 'buyBook',
    ...
    render() {
        ...
        return (
            <Layout className="layout">
                ...
                <Content style={{maxWidth: '1200px', margin: '64px auto 0px auto'}}>
                <div style={{display:'flex', height:'130', width: '100%'}}>
                    ...
                    <div style={{width: '100%', background: '#fff', padding: 24, minHeight: "650px" }}>
                        <div style={{display: 'flex', flexWrap:'wrap', justifyContent: 'space-around'}}>
                            ...
                            <BuyBookForm style={{margin:'10px auto', }}/>
...
export default UserAddBuyBookComponent;